    ...
    const fetchUnapprovedUsers = async (token) => {
        ...
        setError('');
        const res = await axios.get('https://alumni-student-connect-gamma.vercel.app/api/users/admin/dashboard', {
            headers: {
    ...
    const approveUser = async (userId) => {
        ...
        setSuccess('');
        const token = localStorage.getItem('admin_token');
        await axios.post(`https://alumni-student-connect-gamma.vercel.app/api/users/approve/${userId}`, {}, {
            headers: {
            Authorization: `Bearer ${token}`,
            },
        });
